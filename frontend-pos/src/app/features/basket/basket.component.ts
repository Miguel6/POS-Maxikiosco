...
import {IProduct, ProductSearch} from './models/product-search';
...
export class BasketComponent implements OnInit {
  ...
  public categories: Category[] = [
    ...
    new Category(11, 'Categoria 11'),
    new Category(12, 'Categoria 12'),
    new Category(13, 'Categoria 13'),
    new Category(14, 'Categoria 14'),
    new Category(15, 'Categoria 15'),
    new Category(16, 'Categoria 16'),
    new Category(17, 'Categoria 17'),
    new Category(18, 'Categoria 18'),
    new Category(19, 'Categoria 19'),
    new Category(20, 'Categoria 20'),
    new Category(21, 'Categoria 21'),
  ]
  public items: ItemCardModel[] = [
    {
      id: 1,
      image: null,
      description: 'Nombre recontra mega archi largo y aun mas largo',
